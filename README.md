...
#### 1. 🎓 Для Кадетов (Личный мониторинг)
...
#### 2. 👤 Для всех сотрудников (Личный кабинет)
Каждый сотрудник может в любой момент проверить свое положение в департаменте:
* **Личная статистика:** Просмотр актуальной информации о себе: текущий отдел, количество наигранных часов и активные выговоры.
* **Дата повышения:** Проверка даты следующего повышения.

#### 3. 👨‍🏫 Для Police Academy (Инструкторский блок)
...
#### 4. 🦅 Для Руководящего состава (Staff Panel 11+)
...
* **Интерактивный список:** Информационное окно. Позволяет видеть список игроков онлайн, готовых к повышению(учитывается колличество пройденых дней, активные выговоры и т.д).
...
| **Ctrl + R** | Безопасная проверка обновлений лекций и скрипта |# FractionManager
